...
type EmbeddingsServiceClient interface {
	GetEmbeddings(ctx context.Context, in *InterestsRequest, opts ...grpc.CallOption) (*InterestsResponse, error)
}
...
func (c *embeddingsServiceClient) GetEmbeddings(ctx context.Context, in *InterestsRequest, opts ...grpc.CallOption) (*InterestsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InterestsResponse)
...
type EmbeddingsServiceServer interface {
	GetEmbeddings(context.Context, *InterestsRequest) (*InterestsResponse, error)
...
func (UnimplementedEmbeddingsServiceServer) GetEmbeddings(context.Context, *InterestsRequest) (*InterestsResponse, error) {
...
func _EmbeddingsService_GetEmbeddings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmbeddingsServiceServer).GetEmbeddings(ctx, req.(*InterestsRequest))
	}
